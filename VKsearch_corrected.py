...
def get_users_friends_groups(params, url_friends_get, url_group):
    ...
    while len(list_friends_user) > 0:
        ...
        try:
            ...
            if DEBUG_MODE:
                print(data, data_groups_list, sep='\n')
    ...
    print(' '.join(['Это группы, в которых состоит только пользователь:'], [group_task]))
...
if __name__ == '__main__':
    ...
    get_users_friends_groups(params, url_friends_get, url_group)